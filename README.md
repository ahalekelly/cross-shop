...
The script form is `uv run --project . storefront.py …`. After installation, use the `storefront` console command. A source checkout can also be run with `uvx --from . storefront …`.
